...
CACHE_TELEMETRY_PATH = DATA_DIR / "cache_telemetry.json"
PROVIDER_BUDGET_PATH = DATA_DIR / "provider_budgets.json"
PROVIDER_VALIDATION_PATH = DATA_DIR / "provider_validation.json"
