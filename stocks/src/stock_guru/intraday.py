...
class IntradayMarketContext:
    ...
    multi_timeframe_aligned: bool = True
    data_health_usable: bool = True
    timeframe_conflicts: tuple[str, ...] = ()
...
def intraday_score(
    ...
    *,
    ...
    add(context.multi_timeframe_aligned, 6, "intraday timeframes conflict")
...
def evaluate_intraday_entry(
    ...
    *,
    ...
    if not context.data_health_usable:
        reasons.append("market-data quality or provenance is not usable")
    reasons.extend(context.timeframe_conflicts)
