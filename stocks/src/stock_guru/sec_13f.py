        ...
        signals.append(
            {
                ...
                "share_delta": delta,
                "as_filed_value": reference.value_as_filed,
                "side": side,
    ...
    *,
    ...
    for entry in enabled:
        ...
        try:
            ...
            research_signals.extend(changes)
    ...
    bounded_research_signals = sorted(
        research_signals,
        key=lambda item: (float(item.get("as_filed_value") or 0), abs(float(item.get("share_delta") or 0))),
        reverse=True,
    ...
    status_payload = {
        ...
        "research_only": True,
        # This queue is intentionally separate from copy_signals.json. It lets
        # Argentum research an institutional holding change without granting a
        # delayed 13F disclosure any order or mirror eligibility.
        "research_signals": bounded_research_signals,
